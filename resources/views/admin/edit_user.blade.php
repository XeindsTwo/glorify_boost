@include('fragments/head', ['title' => 'GlorifyBoost | Редактирование пользователя'])
<body class="body">
...
<section class="admin">
  <div class="container container--admin">
    <div class="admin__wrapper">
      ...
      <a class="admin__back" href={{route('admin.users.index')}}>Вернуться назад к пользователям</a>
      <form id="updateForm" action="{{ route('admin.users.update', ['user' => $user]) }}" method="POST">
        ...
        <button class="admin__btn" type="submit" id="updateButton">Обновить</button>
      </form>
    </div>
  </div>
</section>
