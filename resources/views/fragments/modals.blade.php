...
<div class="modal modal--active" id="modal-register">
  ...
  <form class="modal__form" id="formAuth" method="post" action="{{route('register')}}">
    @csrf
    <ul class="modal__list">
      ...
      <li class="auth__item">
        ...
        <input class="input" id="password" required type="password" placeholder="Введите пароль" name="password">
      </li>
      <li>
    ...
    <p class="modal__question">
      ...
      <button class="modal__link" type="button" id="auth-btn">
        Войти
      </button>
    </p>
  </form>
...
<div class="modal" id="modal-auth">
  ...
  <form class="modal__form" method="post" action="{{url('/login')}}">
    @csrf
    ...
    <p class="modal__question">
      ...
      <button type="button" id="btn-register" class="modal__link">
        Регистрация
      </button>
    </p>
  </form>
